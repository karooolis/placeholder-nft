          ...
          <div className="max-w-lg mx-auto text-center">
            <div className="flex flex-col px-12 mt-10 space-y-5 sm:px-0 sm:space-y-0 sm:space-x-5 sm:flex-row sm:items-center sm:justify-center">
              <a
                href="#"
                title=""
                className="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-gray-900 transition-all duration-200 border border-gray-900 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-900 hover:text-white"
                role="button"
              >
                Join Discord
              </a>
              ...
              <a
                href="#"
                title=""
                className="relative inline-flex items-center justify-center py-3 pl-16 pr-8 text-base font-bold text-white transition-all duration-200 bg-gray-900 border border-gray-900 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-700"
                role="button"
              >
